...
export const translations = {
  cs: {
    ...
    hero: {
      ...
      photoAlt: 'Focaccia sendvič držený v rukou',
    },
    openNow: {
      open: 'Otevřeno',
      closed: 'Zavřeno',
    ...
    gallery: {
      ...
      focacciaTomato: 'Focaccia s olivami, rajčaty a bylinkami',
      babka: 'Plech tiramisu babky',
      sandwich: 'Focaccia s fetou, olivami a červenou cibulí',
      makovyUzlik: 'Makové uzlíky v přepravce',
  ...
  en: {
    ...
    hero: {
      ...
      photoAlt: 'A focaccia sandwich held in two hands',
    },
    openNow: {
      open: 'Open',
      closed: 'Closed',
    ...
    gallery: {
      ...
      focacciaTomato: 'Focaccia with olives, tomato and herbs',
      babka: 'A tray of tiramisu babka',
      sandwich: 'Focaccia with feta, olives and red onion',
      makovyUzlik: 'Poppyseed knots in a crate',
      focacciaProsciutto: 'Focaccia with prosciutto and rocket',
    },
